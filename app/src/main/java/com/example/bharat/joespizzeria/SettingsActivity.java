...
import com.example.bharat.joespizzeria.utility.FilePaths;
...
public class SettingsActivity extends AppCompatActivity implements
    ...
    //widgets
    private EditText mEmail, mCurrentPassword, mName, mPhone,mAddress;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAddress = (EditText) findViewById(R.id.default_address);
            ...
            public void onClick(View v) {
                ...
                if(!mAddress.getText().toString().equals("")){
                    reference.child(getString(R.string.dbnode_users))
                            ...
                            .setValue(mAddress.getText().toString());
                }
                else {
                    Toast.makeText(SettingsActivity.this, "Please Fill all the fields!", Toast.LENGTH_SHORT).show();
                }
        ...
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot singleSnapshot: dataSnapshot.getChildren()){
                    ...
                    mAddress.setText(user.getDefault_address());
